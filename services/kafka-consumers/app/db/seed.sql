...
VALUES
  ...
  ('ocid-008', 'spark_ml_huggingface',      '45', '45', true,   55.0, 78000000, 'Balfour Beatty'),
  ('ocid-009', 'spark_ml_huggingface',      '72', '72', true,   61.5, 44000000, 'Fujitsu'),
  ('ocid-010', 'spark_ml_huggingface',      '79', '72', false,  58.2, 19000000, 'Capita'),
  ('ocid-011', 'spark_ml_huggingface',      '79', '79', true,   49.0, 16000000, 'Serco'),
  ('ocid-012', 'spark_ml_huggingface',      '85', '85', true,   72.3, 58000000, 'NHS Supply Chain'),
  ('ocid-013', 'spark_ml_huggingface',      '48', '48', true,   41.7, 12000000, 'Microsoft UK'),
  ('ocid-014', 'spark_ml_huggingface',      '73', '71', false,  66.9,  7000000, 'Atkins'),

  -- deeplearning_onnx — neural net via ONNX: low latency, ~86% accurate
  ('ocid-015', 'deeplearning_onnx_huggingface', '45', '45', true,   22.4, 69000000, 'Skanska'),
  ('ocid-016', 'deeplearning_onnx_huggingface', '48', '48', true,   19.8, 11000000, 'Oracle UK'),
  ('ocid-017', 'deeplearning_onnx_huggingface', '60', '60', true,   28.1, 27000000, 'Stagecoach'),
  ('ocid-018', 'deeplearning_onnx_huggingface', '72', '72', true,   25.6, 51000000, 'IBM UK'),
  ('ocid-019', 'deeplearning_onnx_huggingface', '79', '79', true,   31.2, 14000000, 'Serco'),
  ('ocid-020', 'deeplearning_onnx_huggingface', '85', '85', true,   24.9, 60000000, 'NHS Supply Chain'),
  ('ocid-021', 'deeplearning_onnx_huggingface', '71', '90', false,  33.5,  3800000, 'Veolia'),
